    ...
    Map<String, Set<UUID>> todaysLoginsByGroupWithFilterOp =
        users.stream()
             ...
             .collect(groupingBy(User::group,
                                 mapping(User::id,
                                 toSet())));
    System.out.println("todaysLoginsByGroupWithFilterOp = " + todaysLoginsByGroupWithFilterOp);
}
...
// WITH COLLECT FILTER
{
    ...
    System.out.println("todaysLoginsByGroupWithFilteringCollector = " + todaysLoginsByGroupWithFilteringCollector);
}
